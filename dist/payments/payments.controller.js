...
__decorate([
    (0, swagger_1.ApiOperation)({ summary: 'Barcha payment larni olish' }),
    (0, common_1.Get)(),
    __metadata("design:type", Function),
...
__decorate([
    (0, swagger_1.ApiOperation)({ summary: 'Bitta payment ni olish' }),
    (0, common_1.Get)(':id'),
...
__decorate([
    (0, swagger_1.ApiOperation)({ summary: 'Paymentni yangilash' }),
    (0, common_1.Patch)(':id'),
    __param(0, (0, common_1.Param)('id')),
...
__decorate([
    (0, swagger_1.ApiOperation)({ summary: 'Paymentni o‘chirish' }),
